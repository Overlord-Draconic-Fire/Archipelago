...
gallery_location_data_table: Dict[str, SlayThePrincessLocationData] = {
    ...
    LocationName.gallery_razor[6]: SlayThePrincessLocationData(RegionName.razor_chap3, offset + memories + 706),
    LocationName.gallery_razor[7]: SlayThePrincessLocationData(RegionName.razor_chap3, offset + memories + 707),
    LocationName.gallery_razor[8]: SlayThePrincessLocationData(RegionName.razor_chap3, offset + memories + 708),
    LocationName.gallery_razor[9]: SlayThePrincessLocationData(RegionName.razor_no_way, offset + memories + 709),
    LocationName.gallery_razor[10]: SlayThePrincessLocationData(RegionName.razor_chap3, offset + memories + 710),
    LocationName.gallery_razor[11]: SlayThePrincessLocationData(RegionName.razor_chap3, offset + memories + 711),
    LocationName.gallery_razor[12]: SlayThePrincessLocationData(RegionName.razor_chap4, offset + memories + 712),
    LocationName.gallery_razor[13]: SlayThePrincessLocationData(RegionName.razor_destruction, offset + memories + 713),
    LocationName.gallery_razor[14]: SlayThePrincessLocationData(RegionName.razor_empty, offset + memories + 714),
    ...
    LocationName.gallery_apotheosis[6]: SlayThePrincessLocationData(RegionName.apotheosis_paranoid_sword, offset + memories + 1506),
    LocationName.gallery_apotheosis[7]: SlayThePrincessLocationData(RegionName.apotheosis_paranoid_sword, offset + memories + 1507),
