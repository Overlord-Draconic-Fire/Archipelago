...
gallery_location_data_table: Dict[str, SlayThePrincessLocationData] = {
    ...
    LocationName.gallery_fury[8]: SlayThePrincessLocationData(RegionName.fury_unarmed_contrarian, offset + memories + 1408),
    LocationName.gallery_fury[9]: SlayThePrincessLocationData(RegionName.fury_tower, offset + memories + 1409),
    LocationName.gallery_fury[10]: SlayThePrincessLocationData(RegionName.fury_unarmed_contrarian, offset + memories + 1410),
    LocationName.gallery_fury[11]: SlayThePrincessLocationData(RegionName.fury_unarmed_contrarian, offset + memories + 1411),
